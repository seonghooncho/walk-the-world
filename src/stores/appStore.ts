...
import { posts as initialPosts, currentUser as initialUser, cityUsers, cities } from "@/data/mockData";
import { cityMissions as rawMissions, computeCityMissions } from "@/data/missionData";
import type { Post, UserProfile } from "@/data/mockData";
